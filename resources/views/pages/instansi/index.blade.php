                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    @foreach($this->daftarInstansi as $instansi)
                        <a href="{{ route('instansi.show', $instansi['id']) }}" wire:navigate
                           class="flex flex-col items-center text-center rounded-2xl border border-neutral-200/60 bg-white p-6 sm:p-7 transition-all hover:border-amber-300 hover:shadow-[0_8px_30px_-8px_rgba(217,119,6,0.12)] group h-[220px] sm:h-[250px] justify-center overflow-hidden">
                            ...
                            <div class="mt-3 sm:mt-4">
                                ...
                                <p class="mt-1 text-xs text-amber-600 font-medium capitalize truncate">{{ $instansi['tipe'] }}</p>
                            </div>
                        </a>
                    @endforeach
                </div>
