...
<div>
    ...
    <section class="bg-white">
        <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:py-16">
            ...
            <a href="{{ route('instansi.index') }}" wire:navigate class="fade-up inline-flex items-center gap-1.5 text-sm text-neutral-500 hover:text-brand-600 transition-colors mb-8">
                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
                Semua OPD
            </a>

            <div class="fade-up flex items-start gap-5 mb-10">
                <div class="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-brand-50 text-xl font-bold text-brand-600 ring-1 ring-brand-200/50">
            ...
            @if($instansi->deskripsi_layanan)
                <div class="fade-up-scale mb-10 rounded-2xl border border-neutral-200/60 bg-neutral-50/50 p-6">
            ...
            @if(count($this->daftarLayanan) > 0)
                <div class="fade-up-child grid grid-cols-1 gap-4 sm:grid-cols-2">
