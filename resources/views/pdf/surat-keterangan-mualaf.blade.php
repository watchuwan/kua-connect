...
<body>
    ...
    <div class="title">SURAT KETERANGAN MUALAF</div>
    ...
    <div class="content">
        ...
        <table class="data-table">
            ...
            <tr><td>Alamat</td><td>: {{ $data['alamat'] ?? '_________' }}</td></tr>
        </table>

        <p>Benar telah menyatakan diri masuk agama Islam (Muallaf) pada tanggal {{ $data['tanggal_syahadat'] ?? '_________' }} bertempat di {{ $data['tempat_syahadat'] ?? '_________' }} dengan disaksikan oleh:</p>

        <table class="data-table">
            <tr><td>Saksi I</td><td>: {{ $data['nama_saksi_1'] ?? '_________' }}</td></tr>
            <tr><td>Saksi II</td><td>: {{ $data['nama_saksi_2'] ?? '_________' }}</td></tr>
        </table>

        <p>Surat Keterangan ini dibuat untuk keperluan administrasi kependudukan di Dinas Kependudukan dan Pencatatan Sipil (Dukcapil).</p>
    </div>
