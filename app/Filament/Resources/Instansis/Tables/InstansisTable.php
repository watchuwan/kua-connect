        ...
        return $table
            ->columns([
                ImageColumn::make("logo")
                    ...
                    ->defaultImageUrl(
                        fn($record) => "https://ui-avatars.com/api/?name=" .
                            ...
                            "&background=d97706&color=fff&size=40",
                    )
                    ->size(40),
                ...
                TextColumn::make("tipe")
                    ...
                    ->badge()
                    ->color(
                        fn(\App\Enums\TipeInstansi $state) => match ($state) {
                            ...
                            \App\Enums\TipeInstansi::Kelurahan
                                => Color::Emerald,
                            default => Color::Gray,
                        },
                    )
                    ->formatStateUsing(
                        fn(\App\Enums\TipeInstansi $state) => $state->value,
                    ),
